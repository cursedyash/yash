...
from database.database import get_admin_list  # Importing the function to get the admin list
...
async def is_subscribed(filter, client, update):
    ...
    # Get the list of dynamic admins
...
async def decode(base64_string):
    base64_string = base64_string.strip("=")  # Handling padding errors
